...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    saveHandler: function saveHandler() {
      this.$store.dispatch('moduleShortLink/createShortLink', this.link)["catch"](function (err) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    this.$store.dispatch('moduleShortLink/getShortLinks');
  }
});
    ...
    scopedSlots: _vm._u([
      {
        ...
        fn: function() {
          return [
            ...
            _c(
              "tbody",
              _vm._l(_vm.$store.state.moduleShortLink.links, function(item) {
                return _c("tr", { key: item.name }, [
                  _c(
                    "td",
                    [
                      _c("router-link", { attrs: { to: item.short_link } }, [
                        _vm._v(
                          "\n                    " +
                            _vm._s(item.short_link) +
                            "\n                "
                        )
                      ])
                    ],
